      ...
      <div className="max-w-4xl mx-auto mt-40 my-36">
        ...
        <section className='flex flex-col md:flex-row justify-around md:justify-between mb-8 md:mb-36'>
          <article className='flex flex-col md:flex-row gap-8 md:gap-36 items-center md:items-start'>
            <div>
              <div className='flex flex-row gap-3'>
                <h2 className='text-4xl flex items-center italic'>Flix
                </h2>
                <div className='flex items-end'>
                  <Link to='https://flix-dyz2.onrender.com/' target='_blank' className="hover:text-blue-500">
                    live
                  </Link>
                </div>
                <div className='flex items-end'>
                  <Link to='https://github.com/raoulandalis/Flix' target='_blank' className="hover:text-blue-500">
                    github
                  </Link>
                </div>
              </div>
              <p className="max-w-md mt-2">An independently made, movie-app for friend groups to upload, rate, and review movies. Movie-lovers can also categorize movies by creating curated playlists all while contributing to their own profile stats.</p>
            </div>
            <img
        ...
        <section className='flex flex-col md:flex-row justify-around md:justify-between mb-8 md:mb-36'>
          <article className='flex flex-col md:flex-row gap-8 md:gap-36 items-center md:items-start'>
            <div>
              <div className='flex flex-row gap-3'>
                <h2 className='text-4xl flex items-center italic'>Valbnb
                </h2>
                <div className='flex items-end'>
                  <Link to='https://raoul-airbnb.onrender.com/' target='_blank' className="hover:text-blue-500">
                    live
                  </Link>
                </div>
                <div className='flex items-end'>
                  <Link to='https://github.com/raoulandalis/Valbnb' target='_blank' className="hover:text-blue-500">
                    github
                  </Link>
                </div>
              </div>
              <p className="max-w-md mt-2">A Airbnb inspired app based off the theme of the popular game "Valorant", where gaming enthusiasts can create listing of locations they're renting out and leave reviews of places they've visted.</p>
            </div>
            <img
