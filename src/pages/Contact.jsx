  ...
  return (
    <main className='w-full min-h-screen flex justify-center bg-gray-800'>
      <div className="max-w-4xl mx-auto my-36 justify-center">
        <h1 className='text-5xl flex justify-center mb-28 text-blue-500'>{contact.pageTitle}</h1>
        ...
        <div className='flex flex-col items-center gap-6 text-2xl animate-slideUp text-white'>
          ...
          <section className='flex gap-2'>
            ...
            <a className="hover:text-blue-500 cursor-pointer">{contact.email}</a>
          </section>

          <section className='flex gap-2'>
            <img src="https://devicon-website.vercel.app/api/linkedin/original.svg" className='h-8'></img>
            <a href={contact.linkedin.url} target='_blank' rel='noopener noreferrer' className='hover:text-blue-500'>{contact.linkedin.label}</a>
          </section>

          <section className='flex gap-2'>
            <img src="https://devicon-website.vercel.app/api/github/original.svg?color=%232C2CA3" className='h-8'></img>
            <a href={contact.github.url} target='_blank' rel='noopener noreferrer' className='hover:text-blue-500'>{contact.github.label}</a>
          </section>
          ...
          <section className='flex gap-2'>
            ...
            <a href={contact.wellfound.url} target='_blank' rel='noopener noreferrer' className='hover:text-blue-500'>{contact.wellfound.label}</a>
          </section>
          ...
          <section className='flex gap-2'>
            ...
            <a href={contact.resume.url} target='_blank' rel='noopener noreferrer' className='hover:text-blue-500'>{contact.resume.label}</a>
          </section>
        </div>
